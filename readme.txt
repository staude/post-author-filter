...
Tags: page, post, author, filter, editpage
...
This Plugin extends the post/page list and adds a author filter
...
Dieses Plugin fügt der Seiten / Beiträge Auflistung einen Filter nach Autorennamen hinzu.
...
1. Install the plugin from within the Dashboard or upload the directory `post-author-filter` and all its contents to the `/wp-content/plugins/` directory
...
Select the project "WP Plugin: Post Author Filter" and report it.
...
Wähle das Projekt "WP Plugin: Post Author Filter" und melde den Fehler.

= Ich möchte eine neue Funktion vorschlage  =

Bitte geh auf die Seite http://bugs.staude.net und melde dich dort an.

Wähle das Projekt "WP Plugin: Post Author Filter" und trag deinen Wunsch ein.



== Screenshots ==
1. The Postlist with new author filter
